...
<body>
	<div style="display:flex; height:260px;">
		<div style="width:800px;">
			...
			<a href="step3.do"><button class="btn">다음 스텝으로</button></a>
			<br><span style="margin-left:470px; font-size:38px; font-weight:600; font-family: 'Jeju Gothic', sans-serif; color:#1cad78;">Step 2</span><br>
		...
		<div style="font-size:25px; font-weight:590; font-family: 'Jeju Gothic', sans-serif; color:black; width:1200px;">
			...
			<progress id="progress" value="66" min="0" max="100"></progress>
			66%
	...
	<div style="display:flex; height:650px;">
		<div>
			<video controls autoplay muted width="960" height="760" style="margin-top:-111px;">
				<source src="resources/images/step2.mp4" type="video/mp4">
			</video>
		</div>
		<div>
