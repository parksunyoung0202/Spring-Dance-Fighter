...
<body>
	...
	<div style="display:flex; height:260px;">
		<div style="width:800px;">
			<br>&emsp;<a href="sabbing.do"><button class="btn">연습 그만하기</button></a>&emsp;&emsp;
			<a href="step2.do"><button class="btn">다음 스텝으로</button></a>
			<br><span style="margin-left:470px; font-size:38px; font-weight:600; font-family: 'Jeju Gothic', sans-serif; color:#1cad78;">Step 1</span><br>
		...
		<div style="font-size:25px; font-weight:590; font-family: 'Jeju Gothic', sans-serif; color:black; width:1200px;">
			...
			<progress id="progress" value="33" min="0" max="100"></progress>
			33%
			...
			<div style="display:flex">
				<div class="circle_progress" style="margin-left:300px; margin-top:25px;">
				  ...
				  <div class="value">
				  	...
				  	<span id="timer" style="position:absolute; bottom:-30px; left:30px; font-size:40px; font-weight:590; font-family: 'Jeju Gothic', sans-serif; color:black;"></span>
				  </div>
				</div>
				...
				<div class="circle_progress" style="margin-left:120px; margin-top:25px;">
				  ...
				  <div class="value">
				  	...
				  	<span id="timer2" style="position:absolute; bottom:-30px; left:30px; font-size:40px; font-weight:590; font-family: 'Jeju Gothic', sans-serif; color:black;"></span>
				  </div>
				</div>
				...
				<div class="circle_progress" style="margin-left:120px; margin-top:25px;">
				  ...
				  <div class="value">
				  	...
				  	<span id="timer3" style="position:absolute; bottom:-30px; left:30px; font-size:40px; font-weight:590; font-family: 'Jeju Gothic', sans-serif; color:black;"></span>
				  </div>
				</div>
			</div>
	...
	<div style="display:flex; height:650px;">
		<div>
			<video autoplay muted controls width="960" height="760" style="margin-top:-111px;">
				<source src="resources/images/step1.mp4" type="video/mp4">
			</video>
		</div>
		<div>
